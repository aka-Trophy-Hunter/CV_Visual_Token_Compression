...
def qwen25vl_vision_tower_forward_divprune(self, hidden_states: torch.Tensor, grid_thw: torch.Tensor) -> torch.Tensor:
        """
        Args:
        ...
        # print(f"total_token_num: {image_feature_length}")
...
def qwen25vl_generation_forward_divprune(
    self,
